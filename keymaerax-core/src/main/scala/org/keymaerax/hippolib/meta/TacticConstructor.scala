...
/**
 * Helper class for constructing anonymous instances of [[TacticConstructor]].
 *
 * The helper class accepts and overrides `uniqueName`, `args`, and `vararg` as constructor parameters, which means they
 * are initialized before the trait constructor runs. This is necessary because the trait constructor does a few
 * operations that require these parameters to be initialized.
 *
 * In Scala 3, these values should instead be turned into trait parameters and this helper class removed.
 */
abstract class TacticConstructorHelper[T <: Tactic](
    override val uniqueName: String,
    override val args: IndexedSeq[TacticArgInfo[TacticArg]],
    override val vararg: Boolean = false,
) extends TacticConstructor[T]
...
object TacticConstructor {
  def arg0[T <: Tactic](uniqueName: String)(tactic: => T): TacticConstructor[T] =
    new TacticConstructorHelper[T](uniqueName = uniqueName, args = IndexedSeq()) {
  ...
  def arg1[A1 <: TacticArg, T <: Tactic](uniqueName: String, arg1: TacticArgInfo[A1], vararg: Boolean = false)(
    ...
    new TacticConstructorHelper[T](uniqueName = uniqueName, args = IndexedSeq(arg1), vararg = vararg) {
      override def construct(values: Seq[Any]): T = {
        val Seq(val1) = values
  ...
  )(build: (arg1.arg.Type, arg2.arg.Type) => T): TacticConstructor[T] =
    new TacticConstructorHelper[T](uniqueName = uniqueName, args = IndexedSeq(arg1, arg2), vararg = vararg) {
      override def construct(values: Seq[Any]): T = {
  ...
  def arg3[A1 <: TacticArg, A2 <: TacticArg, A3 <: TacticArg, T <: Tactic](
      ...
      vararg: Boolean = false,
  )(build: (arg1.arg.Type, arg2.arg.Type, arg3.arg.Type) => T): TacticConstructor[T] =
    new TacticConstructorHelper[T](uniqueName = uniqueName, args = IndexedSeq(arg1, arg2, arg3), vararg = vararg) {
      override def construct(values: Seq[Any]): T = {
  ...
  def arg4[A1 <: TacticArg, A2 <: TacticArg, A3 <: TacticArg, A4 <: TacticArg, T <: Tactic](
    ...
    new TacticConstructorHelper[T](
      uniqueName = uniqueName,
      args = IndexedSeq(arg1, arg2, arg3, arg4),
      vararg = vararg,
    ) {
      override def construct(values: Seq[Any]): T = {
  ...
  def arg5[A1 <: TacticArg, A2 <: TacticArg, A3 <: TacticArg, A4 <: TacticArg, A5 <: TacticArg, T <: Tactic](
    ...
    new TacticConstructorHelper[T](
      uniqueName = uniqueName,
      args = IndexedSeq(arg1, arg2, arg3, arg4, arg5),
      vararg = vararg,
    ) {
      override def construct(values: Seq[Any]): T = {
