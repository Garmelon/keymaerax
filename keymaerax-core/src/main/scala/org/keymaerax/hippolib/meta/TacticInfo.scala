...
object TacticInfo {
  def apply[T <: Tactic](tactic: T): TacticInfo = TacticInfo(constructor = TacticConstructor(tactic))

  def apply[A1 <: TacticArg, T <: Tactic](arg1: TacticArgInfo[A1])(build: (arg1.arg.Type) => T): TacticInfo =
    TacticInfo(constructor = TacticConstructor(arg1)(build))
  ...
  ): TacticInfo = TacticInfo(constructor = TacticConstructor(arg1, arg2)(build))
  ...
  def apply[A1 <: TacticArg, A2 <: TacticArg, A3 <: TacticArg, T <: Tactic](
    ...
    TacticInfo(constructor = TacticConstructor(arg1, arg2, arg3)(build))
  ...
  def apply[A1 <: TacticArg, A2 <: TacticArg, A3 <: TacticArg, A4 <: TacticArg, T <: Tactic](
    ...
    TacticInfo(constructor = TacticConstructor(arg1, arg2, arg3, arg4)(build))
  ...
  def apply[A1 <: TacticArg, A2 <: TacticArg, A3 <: TacticArg, A4 <: TacticArg, A5 <: TacticArg, T <: Tactic](
    ...
    TacticInfo(constructor = TacticConstructor(arg1, arg2, arg3, arg4, arg5)(build))
}
